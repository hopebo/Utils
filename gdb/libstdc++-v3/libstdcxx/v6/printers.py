...
class SmartPtrIterator(Iterator):
    ...
    def __next__(self):
        ...
        cv.gdb_set_convenience_variable(cv_name, val)
        return ('$%s' % cv_name, AdaptDisplay(val))
...
class SharedPointerPrinter:
    ...
    def __init__ (self, typename, val):
        ...
        self.val = val
        # Cast as the real type of object
        self.pointer = val['_M_ptr'].cast(
            self.val.type.template_argument(0).pointer())
...
class UniquePointerPrinter:
    ...
    def to_string (self):
        ...
        return "std::unique_ptr<{}> containing {}".format(
            ...
            cv.gdb_print_cv(cv_name, AdaptDisplay(self.pointer)))
